...
router.post('/send', async (req, res) => {
  try {
    ...
    // Configure the secure Nodemailer transporter using SMTP and your App Password
    ...
    const mailOptions = {
      from: email,
      to: 'admin@university.com', // Directing student inquiries straight to the admin inbox
      subject: `New UniEvents Inquiry: [${inquiryType}] from ${firstName} ${lastName}`,
      html: `
        <div style="font-family: sans-serif; padding: 20px; color: #0f172a; max-width: 600px; border: 1px solid #e2e8f0; rounded: 12px;">
