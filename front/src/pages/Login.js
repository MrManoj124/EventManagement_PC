          ...
          <div className="p-10">
            ...
            <form className="space-y-5" onSubmit={handleLogin}>
              ...
              <div className="flex items-center px-1">
                <input
                  ...
                  type="checkbox"
                />
                <label className="ml-2 text-xs font-semibold text-slate-500" htmlFor="remember">
                  Remember me on this device
                </label>
              </div>

              <button
                className="w-full bg-[#137fec] hover:bg-[#116ecf] text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-[#137fec]/20 active:scale-[0.98]"
                type="submit"
              >
                Sign In
              </button>
            ...
            <div className="mt-10 text-center">
              <p className="text-slate-500 text-sm font-medium">
                ...
                <Link className="text-[#137fec] font-extrabold hover:underline" to="/register">
                  Register here
                </Link>
              </p>
            </div>
